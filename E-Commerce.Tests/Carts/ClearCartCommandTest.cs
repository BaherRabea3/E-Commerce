...
namespace E_Commerce.Tests.Carts
{
    public class ClearCartCommandTest
    {
        ...
        [Fact]
        public async Task Handler_Shoule_ReturnFailur_When_CartIsNotFound()
        {
            var command = new ClearCartCommand(1);
        ...
        [Fact]
        public async Task Handler_Shoule_ReturnSuccess_When_CartIsFound()
        {
            var command = new ClearCartCommand(3);
